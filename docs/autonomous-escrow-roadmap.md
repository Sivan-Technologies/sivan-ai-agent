...
| Compliance MVP | ✅ Completed for risk-gated MVP | Seller payout setup stores resolved account name, name-match score/level, verification provider/time, shared-account count/flag, and release readiness blocks weak/failed/shared/high-value payout paths. Admin Platform Controls can adjust audited Naira limits for new, trusted, and established buyers plus buyer/platform active exposure |
