...
- `PAYOUT_VERIFICATION_TEST_MODE` - Controlled E2E test override. Set `true` only while using a Paystack `sk_test_...` key. It never activates with live Paystack credentials.
