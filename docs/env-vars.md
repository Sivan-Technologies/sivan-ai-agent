...
- `ACTIVE_PAYOUT_PROVIDER` - Future payout provider selector. Keep `manual_bank_transfer` until a provider-specific payout adapter is implemented and live low-value payout proof passes.
